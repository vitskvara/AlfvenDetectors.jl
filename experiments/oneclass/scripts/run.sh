#!/bin/bash
~/julia-1.1.1/bin/julia ../run_experiment.jl AE 128 2 32 64 --kernelsize=5 --savepath=opt_runs/models --eta=0.0001 --nepochs=50 --batchnorm --resblock --verb --savepoint=50 --nonnormalized
